...
use linkpearl_core::Event;
use nostr_sdk::prelude::MockRelay;

fn done(pump: &mut Pump, nodes: &[&linkpearl_core::Node], who: usize, handle: u64, what: &str) -> String {
...
fn device_lists_and_invites_through_a_local_relay() {
    ...
    let invite: linkpearl_core::FriendInvite = ticket.parse().unwrap();
