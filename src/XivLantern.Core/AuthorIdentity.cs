...
/// signs announcements stays in one file on the author's own machine (<c>lantern author keygen</c>), and the
...
{
    /// <summary>ed25519 public key, 64 lowercase hex characters, from <c>lantern author pubkey</c>.</summary>
    public const string PublicKeyHex = "";

    /// <summary>NodeIds (64 hex) of the author's always-on nodes, from the ready line of <c>lantern --author-mode</c>.</summary>
