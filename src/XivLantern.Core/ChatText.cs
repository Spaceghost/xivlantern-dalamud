...
{
    /// <summary>LT_MAX_CHAT: the largest 1:1 text or support message, in UTF-8 bytes.</summary>
    public const int MaxChatBytes = 2048;

    /// <summary>What a channel line may be. Below LT_MAX_ROOM_MESSAGE (6144): channels are chat too.</summary>
