...
public static class Privacy
{
    public const string Summary =
        "Linkpearl is peer to peer: your game connects straight to your friends' games, and nothing goes through a " +
        "Linkpearl server. Nothing from the game is ever sent — not your character's name, world, location or chat. " +
    ...
    public const string Storage =
        ...
        "an SSH key. Anyone with that folder can act as you on Linkpearl.";

    public const string TermsOfService =
        "Third-party plugins are against the FINAL FANTASY XIV terms of service. Linkpearl never automates or sends a game " +
